...
# We will leave the original columns unchanged, and only add derived columns
...
treatment_switchover_date = '2017-02-02'
df['patient_treated'] = (df['Infusion Date'].values >=
                         treatment_switchover_date)
...
output_filename = os.path.join(args.confidential_data_dir, args.output_file)
